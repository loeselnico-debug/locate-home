...
import StoreModal from './StoreModal'; // <--- Import de la modale
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      ...
      <div className="flex-1 overflow-y-auto px-[4vw] pb-[12vh] no-scrollbar">
        ...
        {/* BOUTON D'APPEL À LA BOUTIQUE */}
        {tool.isConsumable && isLow && (
          <button 
            onClick={() => setIsStoreOpen(true)} // <--- Ouvre la modale
            className="w-full bg-[#FF6600] py-4 rounded-xl mb-6 flex items-center justify-center gap-3 shadow-[0_10px_20px_rgba(255,102,0,0.2)] active:scale-95 transition-all animate-pulse"
          >
